...
window.onload = function initWindow() {
	...
	// lab4-b 平移
	var xPa = document.getElementById("xPan");
	xPa.onchange = function(){
		Pan[0] = xPa.value/100;
	}
	var yPa = document.getElementById("yPan");
	yPa.onchange = function(){
		Pan[1] = yPa.value/100;
	}
	var zPa = document.getElementById("zPan");
	zPa.onchange = function(){
		Pan[2] = zPa.value/100;
	}
